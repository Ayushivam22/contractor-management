...
const SignUpForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        console.log("[Signup Form] - Submitting form with data:", formData);
        ...
        try {
            console.log(
                "[Signup Form] - Sending request to /api/auth/register..."
            );
            ...
            console.log(
                `[Signup Form] - Received response with status ${response.status}:`,
                result
            );
            ...
            console.error("[Signup Form] - Fetch request failed:", err);
            ...
            <div className="card-glass rounded-2xl p-8 animate-fade-in">
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-muted-foreground">
                        ...
                        <Link
                            href="/signin"
                            className="text-black hover:text-accent-glow font-medium transition-colors"
                        >
                            Sign in
                        </Link>
                    </p>
